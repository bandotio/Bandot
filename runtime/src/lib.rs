...
pub use pallet_primitives::{TokenPair, TokenSymbol};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("bandotnode"),
...
parameter_types! {
    pub const GetNativeCurrencyId: TokenSymbol = TokenSymbol::BDT;
    pub const GetStableCurrencyId: TokenSymbol =TokenSymbol::BUSD;
    //pub const GetLDOTCurrencyId: TokenSymbol = TokenSymbol::BDOT;
}
...
parameter_type_with_key! {
    pub ExistentialDeposits: |currency_id: TokenSymbol| -> Balance {
        Default::default()
    };
}
